...
{cartItems.map(item => (
    <li key={item.id} className="cart-item">
        ...
        <div className="quality-controls">
            <button className="quality-control-btn" onClick={() => handleDecreaseQuantity(item.id)}>-</button>
            <span>{item.quantity}</span>
            <button className="quality-control-btn" onClick={() => handleIncreaseQuantity(item.id)}>+</button>
